  ...
  return (
    <div>     
      ...
      <footer className="footer">
        ...
        <li>
              <Link to="/aboutus" onClick={handleOpen_abtus}>
                <a>
                About Us
                </a>
              </Link>
            ...
            <li>
            <Link to="/contactus" onClick={handleOpen_contactus}>
              <a>
                Contact Us
                </a>
              </Link>
            ...
            <li>
              <Link to="/terms" onClick={handleOpen_terms}>
              <a>
                Terms of Service
              </a>
              </Link>
            ...
            <li>
              <Link to="/privacy" onClick={handleOpen_privacy}>
              <a >
                Privacy Policy
              </a>
              </Link>
